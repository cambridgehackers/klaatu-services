...
stateprocess_t default_process(Message *);
};
void ADD_ITEMS(State *mStateMap) {
    ...
    addstateitem(CONNECTING_STATE, 0,static_cast<PROCESS_PROTO>(&WifiStateMachineActions::Connecting_process), 0, CONNECT_MODE_STATE);
    ...
    addstateitem(DRIVER_LOADED_STATE, 0,static_cast<PROCESS_PROTO>(&WifiStateMachineActions::Driver_Loaded_process), 0, DEFAULT_STATE);
    addstateitem(DRIVER_LOADING_STATE, static_cast<ENTER_EXIT_PROTO>(&WifiStateMachineActions::Driver_Loading_enter),static_cast<PROCESS_PROTO>(&WifiStateMachineActions::sm_default_process), 0, DEFAULT_STATE);
    ...
    addstateitem(DEFAULT_STATE, 0,static_cast<PROCESS_PROTO>(&WifiStateMachineActions::default_process), 0, 0);
}
