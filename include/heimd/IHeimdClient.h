/*
  Callback interface from Heimd
*/

#ifndef _IHEIMD_CLIENT_H
#define _IHEIMD_CLIENT_H
...
class IHeimdClient : public IInterface
{
protected:
    enum {
...
public:
    DECLARE_META_INTERFACE(HeimdClient);
...
class BnHeimdClient : public BnInterface<IHeimdClient>
{
public:
