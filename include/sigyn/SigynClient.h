/*
  Common client interface for talking with Sigyn
*/

#ifndef _SIGYN_CLIENT_H
#define _SIGYN_CLIENT_H
...
class SigynClient : public BnSigynClient, public IBinder::DeathRecipient
{
public:
...
private:
    sp<ISigynService> mSigynService;
    Vector<int>       mPending;
};

};

#endif  // _SIGYN_CLIENT_H
