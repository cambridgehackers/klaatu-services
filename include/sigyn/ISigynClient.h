/*
  Callback interface from Sigyn
*/

#ifndef _ISIGYN_CLIENT_H
#define _ISIGYN_CLIENT_H
...
class ISigynClient : public IInterface
{
public:
...
public:
    DECLARE_META_INTERFACE(SigynClient);
...
class BnSigynClient : public BnInterface<ISigynClient>
{
public:
